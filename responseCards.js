const responseCards = [
  ...
  {
    text:
      'You make eye contact with the upset animal who gives you a feather-thumbs up! “No feathers off my back mate!” You shop together and offer to payfor their cricket chips.',
    item: 'banana',
    frontImg: 'resp2',
    backImg: 'resp-banana',
  },
  ...
  {
    text:
      'You take an anonymous photo of the earrings. You post it on InstaPaw with a trending hashtag to support your friends in the upset animal’s communities',
    item: 'grapes',
    frontImg: 'resp5',
    backImg: 'resp-grapes',
  },
  ...
  {
    text:
      '“I’m confused. Is that supposedto be me on your t-shirt?” You speak to the bully, who realises their t-shirt is offensive. They apologise and turn their t-shirt inside out. Everyone cheers!',
    item: 'eggplant',
    frontImg: 'resp8',
  ...
  {
    text:
      'You have filmed the whole situation on your phone. You send the video to the octopus and delete it from your phone. The octopus shows the store manager who tells the bully to leave the store and be more respectful next time.',
    item: 'milk',
    frontImg: 'resp14',
    backImg: 'resp-milk',
  },
  ...
  {
    text:
      'You see the upset animal and start chatting with them. The two of you go into the Mega Mart together. “Hey honey! Can you take me to the frozen flies, I hear they’re on special!”',
    item: 'water',
    frontImg: 'resp17',
    backImg: 'resp-water',
  },
  ...
  {
    text:
      'You tell off the bully, making fun of their size. Meanwhile the upset animal is ignored and still needs help.',
    item: 'ice-cream',
    frontImg: 'resp22',
  ...
  {
    text:
      'You throw tomato sauce on the bully, take their photo and put it on Instapaw. You use the bully as the face of your campaign to get their entire species banned from the Mega Mart',
    item: 'ice-cream',
    frontImg: 'resp24',
    backImg: 'resp-ice-cream',
  },
  {
    text:
      'You try to distract everyoneby spraying them with a big fountain of water. When the wet animals get cranky at you, you tell them to lighten up because they all look silly wet!',
    item: 'lollipop',
    frontImg: 'resp25',
  ...
  {
    text:
      '“Keep moving everyone, nothing to see here...Ooh apples are on special!” The upset animal makes eye contact with you. You pretend not to notice and quickly forget about them.',
    item: 'lollipop',
    frontImg: 'resp26',
    backImg: 'resp-lollipop',
  },
  {
    text:
      'As the upset animal you feel overwhelmed. You run home to curl up in bed and cry alone. You promise yourself you will never tell anyone what happened.',
    item: 'lollipop',
    frontImg: 'resp27',
    backImg: 'resp-lollipop',
  },
  ...
  {
    text:
      "'You try to make the upset animal feel better. “There there...I mean there is SOME truth to what the bully said...”",
    item: 'chips',
    frontImg: 'resp29',
    backImg: 'resp-chips',
  },
  {
    text:
      'You laugh uncontrollably at the situation in front of you. Where’s the popcorn?!',
    item: 'chips',
    frontImg: 'resp30',
    backImg: 'resp-chips',
  },
  ...
  {
    text:
      'You cause a scene, throwing bottles of red cordial at the bully’s feet. Everyonegets splashed and animals must leave the store while staff clean up the mess.',
    item: 'chocolate',
    frontImg: 'resp32',
    backImg: 'resp-chocolate',
  },
  ...
  {
    text:
      'You are scared by the situation and hope the bully doesn’t notice you. You quickly finish your shopping so you can go home.',
    item: 'donut',
    frontImg: 'resp34',
    backImg: 'resp-donut',
  },
  ...
  {
    text:
      '“This doesn’t affect me, or my platypus family or friends. It’s probably not my place to get involved.” You are not the same species as the upset animal and you decide it’s best to ‘mind your own business’',
    item: 'muffin',
    frontImg: 'resp38',
    backImg: 'resp-muffin',
  },
